...
export const ShoppinngCart = ({ cart = [], removeFromCart }) => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {cart.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-border bg-card p-10 text-center text-muted-foreground">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Agrega productos desde la sección de productos para verlos aquí.</p>
          <Link
            to="/products"
